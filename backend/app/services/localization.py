...
LABELS = {
    "en": {
        ...
        "call_message": "Aqua Pulse emergency alert. SOS was triggered by {name} at {site}. Priority {priority}. Please open Aqua Pulse and respond immediately.",
    ...
    "hi": {
        ...
        "call_message": "Aqua Pulse आपातकालीन अलर्ट। {name} ने {site} पर SOS शुरू किया है। प्राथमिकता {priority}। कृपया Aqua Pulse खोलें और तुरंत प्रतिक्रिया दें।",
    ...
    "te": {
        ...
        "call_message": "Aqua Pulse అత్యవసర హెచ్చరిక. {name} {site} వద్ద SOS ప్రారంభించారు. ప్రాధాన్యత {priority}. దయచేసి Aqua Pulse తెరిచి వెంటనే స్పందించండి.",
